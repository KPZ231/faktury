...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 15, 2025 at 10:37 AM
...
INSERT INTO `oplaty_spraw` (`id_oplaty_sprawy`, `id_sprawy`, `opis_raty`, `oczekiwana_kwota`, `czy_oplacona`, `data_oplaty`, `faktura_id`) VALUES
(304, 19, 'Rata 1', 3000.00, 1, NULL, 'FV/15/05/2025'),
(305, 19, 'Rata 2', 3000.00, 0, NULL, NULL),
(306, 19, 'Rata 3', 3000.00, 0, NULL, NULL),
(307, 19, 'Rata końcowa', 24000.00, 0, NULL, NULL);
...
(19, 'Ewa Lewandowska', 0, 300000.00, 9000.00, 0.0800, NULL);
...
--
ALTER TABLE `agenci`
  MODIFY `id_agenta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `agenci_wyplaty`
--
ALTER TABLE `agenci_wyplaty`
  MODIFY `id_wyplaty` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT for table `oplaty_spraw`
--
ALTER TABLE `oplaty_spraw`
  MODIFY `id_oplaty_sprawy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=308;

--
-- AUTO_INCREMENT for table `prowizje_agentow_spraw`
--
ALTER TABLE `prowizje_agentow_spraw`
  MODIFY `id_prowizji_agenta_sprawy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `sprawy`
--
ALTER TABLE `sprawy`
  MODIFY `id_sprawy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
